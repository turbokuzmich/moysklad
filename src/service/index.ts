...
export const getNeonAssortment = addCacheKey(
  "assortment.neon",
  async function getNeonAssortment() {
...
export const getDeluxAssortment = addCacheKey(
  "assortment.deluxspa",
  async function getDeluxAssortment() {
    ...
    return assortment
      ...
      .map((item) => {
        ...
        return {
          ...
          itemHref: product.meta.uuidHref,
